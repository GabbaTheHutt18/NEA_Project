...
namespace NEA_Project.ViewModels
{
    public class PairsGameViewModel : ObservableObject
    {
        ...
        private void FinishButtonClicked()
        {
            ...
            try
            {
                string DatabaseScore = _parent.Database.ReadData("UserStats", "HighScore2", $"USERID = {_parent.UserID}", 1)[0];
            ...
            {
                _parent.Database.UpdateData("UserStats", $"HighScore2 = {Score}", $"USERID = {_parent.UserID}");
            }
            Score = 0;
